        ...
        value: function stop() {
            ...
            try {
                for (var _iterator2 = this.events[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
                    ...
                    _get(GameEngine.prototype.__proto__ || Object.getPrototypeOf(GameEngine.prototype), 'removeListener', this).call(this, event, listener);
                }
            } catch (err) {
